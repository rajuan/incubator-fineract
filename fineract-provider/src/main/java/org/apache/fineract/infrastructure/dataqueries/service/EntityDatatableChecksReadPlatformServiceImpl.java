...
public class EntityDatatableChecksReadPlatformServiceImpl implements EntityDatatableChecksReadService {
	...
	@Override
	public List<EntityDataTableChecksData> retrieveAll(final Long status, final String entity, final Long productId) {
	...
	protected static final class EntityDataTableChecksMapper implements RowMapper<EntityDataTableChecksData> {
		...
		public EntityDataTableChecksData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
			...
			return new EntityDataTableChecksData(id, entity, status, datatableName, systemDefined, productId,
					productName);
		}
