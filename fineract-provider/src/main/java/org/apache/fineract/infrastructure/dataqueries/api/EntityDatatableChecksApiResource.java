...
public class EntityDatatableChecksApiResource {
	...
	@Autowired
	public EntityDatatableChecksApiResource(final PlatformSecurityContext context,
	...
	public String retrieveAll(@Context final UriInfo uriInfo, @QueryParam("status") final Long status,
		...
		final List<EntityDataTableChecksData> result = this.readEntityDatatableChecksService.retrieveAll(status, entity,
				productId);
	...
	public String createEntityDatatableCheck(final String apiRequestBodyAsJson) {
		...
		final CommandWrapper commandRequest = new CommandWrapperBuilder()
				.createEntityDatatableChecks(apiRequestBodyAsJson).build();
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	public String deleteDatatable(@PathParam("entityDatatableCheckId") final long entityDatatableCheckId,
