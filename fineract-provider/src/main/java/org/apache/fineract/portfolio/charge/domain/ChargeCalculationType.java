...
public enum ChargeCalculationType {
    ...
    PERCENT_OF_VAT_FREQUENCY(100,"chargeCalculationType.percent.of.vat.frequency");
    ...
    public static Object[] validValuesForLoan() {
        return new Integer[] { ChargeCalculationType.FLAT.getValue(), ChargeCalculationType.PERCENT_OF_AMOUNT.getValue(),
                ...
                ChargeCalculationType.PERCENT_OF_DISBURSEMENT_AMOUNT.getValue(), ChargeCalculationType.PERCENT_OF_VAT_FREQUENCY.getValue()};
    }
    ...
    public static ChargeCalculationType fromInt(final Integer chargeCalculation) {
        ...
        switch (chargeCalculation) {
            ...
            break;
            case 100:
                chargeCalculationType = PERCENT_OF_VAT_FREQUENCY;
            break;
        }
    ...
    public boolean isPercentageBased() {
        return isPercentageOfAmount() || isPercentageOfAmountAndInterest() || isPercentageOfInterest() || isPercentageOfDisbursementAmount() || isPercentageOfVatFrequency();
    }
    ...
    public boolean isPercentageOfVatFrequency(){
        return this.value.equals(ChargeCalculationType.PERCENT_OF_VAT_FREQUENCY.getValue());
    }
}